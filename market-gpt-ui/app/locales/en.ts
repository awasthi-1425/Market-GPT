...
const en: LocaleType = {
  ...
  Auth: {
    ...
    TopTips:
      "🚀 MarketGPT Intelligence: Instantly unlock the latest market-leading models like OpenAI o1, GPT-4o, and Claude-3.5!",
  },
  ChatItem: {
  ...
  Settings: {
    ...
    Access: {
      SaasStart: {
        Title: "Use MarketGPT Pro",
        Label: " (Professional Analysis)",
        SubTitle:
          "Powered by MarketGPT, zero setup needed, unlock OpenAI o1, GPT-4o," +
          " Claude-3.5 and advanced financial intelligence models",
        ChatNow: "Analyze Now",
      },
      AccessCode: {
        Title: "Access Code",
